...
int main(void)
{
  ...
  {
    if(n < (s64)40 || dt1 < 10.0) { dt1 = cpu_time(); f = F_v1(n); dt1 = cpu_time() - dt1; fprintf(file,"%3d 1 %20lld %9.6f\n",(int)n,f,dt1); }
    if(n < (s64)40 || dt2 < 10.0) { dt2 = cpu_time(); f = F_v2(n); dt2 = cpu_time() - dt2; fprintf(file,"%3d 2 %20lld %9.6f\n",(int)n,f,dt2); }
    if(n < (s64)40 || dt3 < 10.0) { dt3 = cpu_time(); f = F_v3(n); dt3 = cpu_time() - dt3; fprintf(file,"%3d 3 %20lld %9.6f\n",(int)n,f,dt3); }
    if(n < (s64)40 || dt4 < 10.0) { dt4 = cpu_time(); f = F_v4(n); dt4 = cpu_time() - dt4; fprintf(file,"%3d 4 %20lld %9.6f\n",(int)n,f,dt4); }
