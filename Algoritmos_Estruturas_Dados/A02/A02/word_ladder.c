...
static void hash_table_grow(hash_table_t *hash_table)
{
  ...
  if(hash_table->number_of_entries >= hash_table->hash_table_size/2){ // realocar heads, passar ponteiros a nullptr, passar 


    hash_table-> hash_table_size = hash_table->hash_table_size * 2+1;  // manter tamanho primo ( gera menos colisões)
  }
  return hash_table;
